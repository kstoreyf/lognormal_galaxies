...
! now output P(k,z) as a function of k
  ...
  open(2,file='wavenumber_gnu.txt')        !modified by Aniket
  open(3,file='wavenumber_dgnudlna.txt')   !modified by Aniket
  open(4,file='wavenumber_fnu.txt')        !modified by Aniket
  k_ov_h=1d-5 ! h/Mpc
  dlnk=2d-2
